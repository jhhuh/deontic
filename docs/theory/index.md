...
This section covers the logical and computational foundations behind the
Deontic framework, from basic modal logic to the specific encoding strategy
we use.

## Reading Path

1. **[Modal Logic](modal-logic.md)** — necessity, possibility, and Kripke semantics
